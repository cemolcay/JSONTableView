#
#  Be sure to run `pod spec lint JSONTableView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "JSONTableView"
  spec.version      = "0.0.1"
  spec.summary      = "Expandable JSON table view."
...
```
  ...
  spec.homepage     = "https://github.com/cemolcay/JSONTableView"
  ...
  spec.source       = { :git => "https://github.com/cemolcay/JSONTableView.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "JSONTableView/*.xcassets"
